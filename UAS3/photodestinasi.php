...
<div class="col-sm-10">
	...
	<form method="POST" enctype="multipart/form-data">
		...
		<div class="form-group row">
			...
			<div class="col-sm-10">
			<select type="form-control" class="form-control" id="kodedestinasi" name="kodedestinasi">
...
// ----------------- AKHIR PAGING -- MEMBUAT GANTI HALAMAN ---------------- >
			...
			if (isset($_POST['kirim'])) {
				...
				where fotodestinasiKODE like '%".$search."%' limit $mulaitampilan, $jumlahtampilan");
			} elseif (isset($_POST['kirim2'])) {
				$search2 = $_POST["search2"];
				$query = mysqli_query($connection,"select * from fotodestinasi
				where fotodestinasiNAMA like '%".$search2."%' limit $mulaitampilan, $jumlahtampilan");
			} else {
				$query = mysqli_query($connection, "select * from fotodestinasi limit $mulaitampilan, $jumlahtampilan");
			}
			$nomor = 1;
