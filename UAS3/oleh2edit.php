...
<?php
	...
	if(isset($_POST['edit']))
	{
		...
		if(($ekstensifile == "jpg") or ($ekstensifile == "JPG") or ($ekstensifile == "png") or ($ekstensifile == "PNG") or ($ekstensifile == "jpeg") or ($ekstensifile == "JPEG") or ($ekstensifile == "WEBP") or ($ekstensifile == "webp"))
		{
			...
			mysqli_query($connection, "update oleh2 
            set olehKODE = '$olehKODE', 
            olehNAMA = '$olehNAMA', 
...
$olehKODE = $_GET['ubah'];
$editoleh = mysqli_query($connection, "select * from oleh2 WHERE olehKODE = '$olehKODE'");
$rowedit = mysqli_fetch_array($editoleh);

$editlokasi = mysqli_query($connection, "select * from oleh2, travel where olehKODE = '$olehKODE'
and oleh2.lokasiKODE = travel.lokasiKODE");
$rowedit2 = mysqli_fetch_array($editlokasi);
...
<div class="col-sm-10">
	...
	<form method="POST" enctype="multipart/form-data">
		...
		<div class="form-group row">
			...
			<div class="col-sm-10">
				<input type="submit" class="btn btn-primary" value="Ubah" name="edit">
