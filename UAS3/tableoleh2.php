            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Data Tabel Oleh-Oleh</h1>
                        </ol>
	...
	<table class="table table-dark table-striped">
		...
		<tbody>
			...
			if (isset($_POST['kirim'])) {
				$search = $_POST["search"];
				$query = mysqli_query($connection,  "select * from oleh2, travel
				where olehKODE like '%".$search."%' and oleh2.lokasiKODE = travel.lokasiKODE");
			} elseif (isset($_POST['kirim2'])) {
				$search2 = $_POST["search2"];
				$query = mysqli_query($connection,"select * from oleh2, travel
				where olehNAMA like '%".$search2."%' and oleh2.lokasiKODE = travel.lokasiKODE");
			} else {
				$query = mysqli_query($connection, "select * from oleh2,travel
				where oleh2.lokasiKODE = travel.lokasiKODE");
			}
			$nomor = 1;
