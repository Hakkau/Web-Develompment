...
<?php
	...
	if(isset($_POST['edit']))
	{
		...
		mysqli_query($connection, "update travel set lokasiKODE = '$lokasiKODE', lokasiNAMA =  '$lokasiNAMA' where lokasiKODE = '$lokasiKODE'");
		header("location:travel.php");
	}

    //menerima kiriman data dari destinasi.php
$kodetravel = $_GET['ubah'];
$edittravel = mysqli_query ($connection, "select * from travel where lokasiKODE = '$kodetravel'");
...
<form method="POST">
  ...
  <div class="mb-3 row">
    ...
    <div class="col-sm-9">
      ...
      value="<?php echo $rowedit["lokasiKODE"]?>" readonly>
    </div>
  </div>
  <div class="mb-3 row">
    ...
    <div class="col-sm-9">
      ...
      value="<?php echo $rowedit["lokasiNAMA"]?>">
    </div>
  </div>
