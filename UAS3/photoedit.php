...
if(isset($_POST['edit'])) // Assuming "edit" is the name attribute of the submit button
{
	...
	set fotodestinasiKODE = '$fotodestinasiKODE', 
...
//menerima kiriman data dari photodestinasi.php
$fotodestinasiKODE = $_GET['ubah'];
$editfotodestinasi = mysqli_query($connection, "select * from fotodestinasi WHERE fotodestinasiKODE = '$fotodestinasiKODE'");
$rowedit = mysqli_fetch_array($editfotodestinasi);

$editdestinasi = mysqli_query($connection, "select * from fotodestinasi, destinasi where fotodestinasiKODE = '$fotodestinasiKODE'
and fotodestinasi.destinasiKODE = destinasi.destinasiKODE");
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Input Foto Destinasi</h1>
<body>
