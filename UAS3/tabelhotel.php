...
<?php
	...
	if(isset($_POST['Simpan']))
	{
		...
		if(($ekstensifile == "jpg") or ($ekstensifile == "JPG") or ($ekstensifile == "png") or ($ekstensifile == "PNG") or ($ekstensifile == "jpeg") or ($ekstensifile == "JPEG"))
		{
			...
			mysqli_query($connection, "insert into hotel value ('$hotelKODE', '$hotelNAMA', '$hotelFOTO', '$lokasiKODE')");
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Data Tabel Hotel</h1>
                        </ol>
...
<!--				<th>Kode Destinasi</th>  -->
		...
		<tbody>
			...
			if (isset($_POST['kirim'])) {
				$search = $_POST["search"];
				$query = mysqli_query($connection,  "select * from hotel, travel
				where hotelKODE like '%".$search."%' and hotel.lokasiKODE = travel.lokasiKODE");
			} elseif (isset($_POST['kirim2'])) {
				$search2 = $_POST["search2"];
				$query = mysqli_query($connection,"select * from hotel, travel
				where hotelNAMA like '%".$search2."%' and hotel.lokasiKODE = travel.lokasiKODE");
			} else {
				$query = mysqli_query($connection, "select * from hotel, travel
				where hotel.lokasiKODE = travel.lokasiKODE");
			}
			$nomor = 1;
...
<!-- 					<td width="5px">
						<a href="photoedit.php?ubah=<?php echo $row["hotelKODE"]?>"
					...
					<td width="5px">
						<a href="photohapus.php?hapus=<?php echo $row["hotelKODE"]?>"
